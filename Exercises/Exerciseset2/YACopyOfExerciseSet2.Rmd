...
<br> 1) 6 components
<br> 2) Tresury bonds
<br> 3) Tresury bonds, currencies, European index, NA index, Euro bonds, Oil, Metales, Corps, Metales, Asian index
<hr> 5)  During a crisis, comodities tend to be more corrlated (usually all moving at the same direction at the same time). Givem higher corrlation, less components are required to predict future prices.
...
**Your Answers here:**
<br> 1) the code is taking moving average of futures prices with differet time windows (in days) and than scale them down to insure 1$ invested every day. the results are plotted on a year/month metrics with return for each cell
<br> 2) `MAfreq<-seq(8,240,by=20)`
<br><!-- Table generated in R 3.3.2 by googleVis 0.6.2 package -->
<!-- Mon Jan 23 19:02:17 2017 -->
...
// jsData 
function gvisDataTableID21784e107ebe () {
...
data.addColumn('string','Jan');
data.addColumn('string','Feb');
data.addColumn('string','Mar');
data.addColumn('string','Apr');
data.addColumn('string','May');
data.addColumn('string','Jun');
data.addColumn('string','Jul');
data.addColumn('string','Aug');
data.addColumn('string','Sep');
data.addColumn('string','Oct');
data.addColumn('string','Nov');
data.addColumn('string','Dec');
...
// jsDrawChart
function drawChartTableID21784e107ebe() {
var data = gvisDataTableID21784e107ebe();
var options = {};
...
options["allowHTML"] = true;
    ...
    document.getElementById('TableID21784e107ebe')
    );
...
callbacks.push(drawChartTableID21784e107ebe);
})();
function displayChartTableID21784e107ebe() {
  var pkgs = window.__gvisPackages = window.__gvisPackages || [];
  var callbacks = window.__gvisCallbacks = window.__gvisCallbacks || [];
...
<!-- jsChart -->  
<script type="text/javascript" src="https://www.google.com/jsapi?callback=displayChartTableID21784e107ebe"></script>
 
<!-- divChart -->
  
<div id="TableID21784e107ebe" 
